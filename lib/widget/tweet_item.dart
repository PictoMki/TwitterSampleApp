                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, '/tweet',arguments: '返信をツイートする',);
                            },
                            child: Row(
                              children: [
                                Icon(Icons.chat_bubble_outline,size: 20,color: AppColors.darkGray),
                                SizedBox(width: 5,),
                                Text('4',style: TextStyle(color: AppColors.darkGray),),
                              ],
                            ),
                          ),
                          InkWell(
                          ...
                          InkWell(
                            ...
                            child: Row(
                              children: [
                                isLike ? Icon(Icons.favorite,size: 20,color: Colors.redAccent,) : Icon(Icons.favorite_border,size: 20,color: AppColors.darkGray),
                                SizedBox(width: 5,),
                                Text(isLike ? '9' : '8',style: TextStyle(color: AppColors.darkGray),),
                              ],
                            ),
                          ),
                        ],
